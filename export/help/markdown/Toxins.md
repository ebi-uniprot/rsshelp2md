...
-   All manually reviewed toxins can be found [here](http://www.uniprot.org/uniprotkb/?query=taxonomy%3Ametazoa+AND+keyword%3Atoxin+AND+reviewed%3Ayes)
-   All manually reviewed venom proteins can be found [here](http://www.uniprot.org/uniprotkb/?query=taxonomy%3A%22Metazoa+%5B33208%5D%22+annotation%3A%28type%3A%22tissue+specificity%22+venom%29+reviewed%3Ayes)
-   All manually reviewed venom proteins and toxins can be found [here](http://www.uniprot.org/uniprotkb/?query=taxonomy%3A%22Metazoa+%5B33208%5D%22+and+(keyword%3Atoxin+OR+annotation%3A(type%3A%22tissue+specificity%22+venom))+AND+reviewed%3Ayes)
